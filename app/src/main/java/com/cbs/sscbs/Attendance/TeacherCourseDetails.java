...
//        CollectionReference class_list = FirebaseFirestore.getInstance().collection("Teachers").document(getName).collection(Classes);
        ...
        DocumentReference sDocRef = FirebaseFirestore.getInstance().document("/Teachers/"+ getName);
//        sDocRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
//            @Override
//            public void onSuccess(DocumentSnapshot documentSnapshot) {
//                DataClas classAlloted;
//                classAlloted = documentSnapshot.toObject(DataClas.class);
//                Log.wtf(TAG, classAlloted.getClasses().toString());
//            }
//        });

        CollectionReference reference = sDocRef.collection(Classes);
